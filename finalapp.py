...
def load_mobilenet_model():
    return load_model('fullfood.keras')
...
BLOCKED_CLASSES = {
    ...
    'mixed_vegetables_with_peanut_sauce',
    'padang_rice',
    'red_velvet_cake',
    'takoyaki',
    'tuna_tartare',
...
def is_blocked(food_key: str) -> bool:
    return food_key in BLOCKED_CLASSES
...
def translate_food_name(name):
    ...
    'beet_salad': 'Salad Bit', 'beignet': 'Roti Goreng Prancis', 'bibimbap': 'Bibimbap', 'black_beef_soup': 'Rawon', 'bread_pudding': 'Puding Roti', 'breakfast_burrito': 'Burrito Sarapan',
    ...
    'creme_brulee': 'Creme Brulee', 'croque_madame': 'Madam Croque', 'cup_cakes': 'Kue Cangkir', 'deviled_eggs': 'Telur Isi',
    ...
    'french_onion_soup': 'Sup Bawang Prancis', 'french_toast': 'Roti Panggang Prancis', 'fried_chicken': 'Ayam Goreng', 'fried_fish': 'Ikan Goreng', 'fried_noodle': 'Mie Goreng', 'fried_rice': 'Nasi Goreng', 'frozen_yogurt': 'Yogurt Beku',
    ...
    'hot_and_sour_soup': 'Sup Asam Pedas', 'hot_dog': 'Hot Dog', 'huevos_rancheros': 'Huevos Rancheros', 'hummus': 'Hummus', 'ice_cream': 'Es Krim', 'indonesian_soup': 'Soto',
    'lasagna': 'Lasagna', 'lobster_bisque': 'Lobster Bisque', 'lobster_roll_sandwich': 'Sandwich Lobster Gulung', 'macaroni_and_cheese': 'Makaroni dan Keju',
    'macarons': 'Makaron', 'miso_soup': 'Sup Miso', 'mixed_vegetables_with_peanut_sauce': 'Gado-Gado', 'mussels': 'Kerang',
    'nachos': 'Nachos', 'omelette': 'Omelet', 'onion_rings': 'Cincin Bawang', 'oysters': 'Tiram',
    'pad_thai': 'Pad Thai', 'padang_rice': 'Nasi Padang', 'paella': 'Paella', 'pancakes': 'Panekuk',
    ...
    'pulled_pork_sandwich': 'Sandwich Babi Suwir', 'ramen': 'Ramen', 'ravioli': 'Ravioli', 'red_velvet_cake': 'Kue Red Velvet', 'rendang': 'Rendang', 'risotto': 'Risotto',
    ...
    'strawberry_shortcake': 'Kue Stroberi', 'sushi': 'Sushi', 'tacos': 'Taco', 'takoyaki': 'Takoyaki', 'tiramisu': 'Tiramisu', 'tuna_tartare': 'Tuna Tartar',
    'waffles': 'Wafel'
    }
...
selected_combined = st.sidebar.selectbox("Pilih makanan:", translated_names, placeholder="Pilih Dari 110 Makanan Berikut")
...
if tanya and user_q:
    if is_blocked(selected_food):
        st.sidebar.info(
            "Informasi nutrisi untuk makanan ini tidak tersedia. "
            "Pemanggilan API dinonaktifkan untuk mencegah hasil yang menyesatkan."
        )
    else:
...
labels = [
    ...
    'Roti Goreng Prancis (Beignet)', 'Bibimbap', 'Rawon (Black Beef Soup)', 'Puding Roti (Bread Pudding)', 'Burrito Sarapan (Breakfast Burrito)', 'Bruschetta', 'Salad Caesar (Caesar Salad)', 'Calamari', 'Cannoli', 
    ...
    'Sandwich Klub (Club Sandwich)', 'Kue Kepiting (Crab Cakes)', 'Creme Brulee', 'Madam Croque (Croque Madame)', 'Kue Cangkir (Cup Cakes)', 'Telur Isi (Deviled Eggs)', 
    ...
    'Kentang Goreng (French Fries)', 'Sup Bawang Prancis (French Onion Soup)', 'Roti Panggang Prancis (French Toast)', 'Ayam Goreng (Fried Chicken)', 'Ikan Goreng (Fried Fish)', 'Mie Goreng (Fried Noodle)',
    ...
    'Guacamole', 'Gyoza', 'Hamburger', 'Sup Asam Pedas (Hot And Sour Soup)', 'Hot Dog', 'Huevos Rancheros', 'Hummus', 'Es Krim (Ice Cream)', 'Soto (Indonesian Soup)',
    'Lasagna', 'Lobster Bisque', 'Sandwich Lobster Gulung (Lobster Roll Sandwich)', 'Makaroni Dan Keju (Macaroni And Cheese)', 'Makaron (Macarons)', 
    'Sup Miso (Miso Soup)', 'Gado-Gado (Mixed Vegetables with Peanut Sauce)', 'Kerang (Mussels)', 'Nachos', 'Omelet (Omelette)', 'Cincin Bawang (Onion Rings)', 'Tiram (Oysters)', 
    'Pad Thai', 'Nasi Padang (Padang Rice)', 'Paella', 'Panekuk (Pancakes)', 'Panna Cotta', 'Bebek Peking (Peking Duck)', 'Pho', 'Pizza', 'Potongan Daging Babi (Pork Chop)',
    'Poutine', 'Iga Utama (Prime Rib)', 'Sandwich Babi Suwir (Pulled Pork Sandwich)', 'Ramen', 'Ravioli', 'Kue Red Velvet (Red Velvet Cake)', 'Rendang', 'Risotto', 
    ...
    'Sushi', 'Tacos', 'Takoyaki', 'Tiramisu', 'Tartar Tuna (Tuna Tartare)', 'Wafel (Waffles)'
]
...
if uploaded_file is not None:
    ...
    with col2:
        ...
        # Jika kelas diblokir, jangan panggil API sama sekali
        if is_blocked(predicted_class):
            st.markdown(
                "**Tidak ada informasi nutrisi yang ditemukan untuk kelas ini.** "
                "API dinonaktifkan untuk mencegah hasil keliru."
            )
        else:
            ...
            if response.status_code == 200:
                ...
                if nutrition_data:
                    ...
                    st.markdown("**<h3>Tidak ada informasi nutrisi yang ditemukan.</h3>**", unsafe_allow_html=True)
            else:
